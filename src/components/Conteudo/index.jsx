...
export default function Conteudo() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-w-screen min-h-screen md:h-screen lg:max-h-screen bg-[#4DA9EC]">
      <ToastContainer />
      ...
      <div className="flex flex-col w-full md:max-h-full relative right-4 left-0 space-y-6 md:space-y-0 bg-[#A4DEFF] rounded-t-[2.5rem] md:rounded-s-[2.5rem] md:rounded-tr-none px-8 py-2 ">
        {!loading && (
          <>
